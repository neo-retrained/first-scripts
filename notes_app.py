"""
A self-designed and self-developed script to practice Python by implementing a notes application. Features include adding, deleting, and saving notes and entries.
Built from scratch without using pre-existing code or external frameworks.
